...
- **Ранжирование** — сначала больше **разных** слов запроса, найденных в документе; затем больше **суммарных вхождений** этих слов; при равенстве — по убыванию строки **`id`** (лексикографически); затем сумма **TF‑IDF**.
