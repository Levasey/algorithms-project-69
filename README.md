...
- **Ранжирование** — сначала больше **разных** слов запроса, найденных в документе; затем больше **суммарных вхождений** этих слов; затем порядок документа в **исходном списке**.
